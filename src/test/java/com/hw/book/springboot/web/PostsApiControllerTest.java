...
// HelloController 와 달리 @WebMvcTest 를 사용하지 않음.
// 이유는 @WebMvcTest 의 경우 JPA 기능이 작동하지 않고, Controller 와 ControllerAdvice 등 외부 연동과 관련된 부분만 활성화 됨
// 그렇기 때문에 JPA 기능까지 한번에 테스트할 때는 @SpringBootTest 와 TestRestTemplate 을 사용하면 됨
// WebEnvironment.RANDOM_PORT -> 랜덤 포트 생성
...
public class PostsApiControllerTest {
    ...
    // MockMvc를 이용해 임의로 인증된 사용자를 생성하여 테스트 진행할수 있도록 세팅 진행
    private MockMvc mvc;
